    ...
    <div className="flex-1 min-h-0 flex flex-col bg-gray-950">
      <div className="flex items-center gap-3 px-4 py-2 border-b border-gray-800 text-xs">
        ...
        {!isBinary && !imageUrl && !loading && (
          <button
            ...
            className="px-3 py-1 rounded bg-emerald-700 hover:bg-emerald-600
                       disabled:bg-gray-800 disabled:text-gray-600 text-white font-medium transition-colors"
          >
            {saving ? "Saving…" : "Save"}
          </button>
        )}
        <button
          onClick={reload}
          disabled={loading}
          className="px-3 py-1 rounded text-gray-300 hover:text-white hover:bg-gray-800
